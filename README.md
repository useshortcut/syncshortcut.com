![Shortcut GitHub Integration Banner](/public/banner.png)
...
This is a system to synchronize Shortcut stories and GitHub issues when a specific label is added.

This allows contributors to work with open source projects without having to give them access to your internal Shortcut team.

:wave: **Visit [SyncShortcut.com](https://syncshortcut.com) to try it!**
...
[![Deploy to DO](https://www.deploytodo.com/do-btn-blue-ghost.svg)](https://cloud.digitalocean.com/apps/new?repo=https://github.com/calcom/syncshortcut.com/tree/main)
...
If you need any help, please check for related [issues](https://github.com/calcom/syncshortcut.com/issues) or open a new one.
